...
class opParams:
  def __init__(self):
    self.default_params = {'camera_offset': {'default': 0.00, 'allowed_types': [float, int], 'description': 'Your camera offset to use in lane_planner.py', 'live': True},  # float and int is important
                           ...
                           'lat_kp': {'default':  0.3, 'allowed_types': [float, int], 'description': 'Lat tuning Kp', 'live': True},
                           'lat_ki': {'default':  0.05, 'allowed_types': [float, int], 'description': 'Lat tuning Ki', 'live': True},
                           'lat_kf': {'default':  0.00003, 'allowed_types': [float, int], 'description': 'Lat tuning Kf', 'live': True},
